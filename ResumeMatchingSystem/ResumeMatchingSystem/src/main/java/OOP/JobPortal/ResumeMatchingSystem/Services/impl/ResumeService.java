...
public class ResumeService extends AbstractResumeService {
    ...
    public ResumeResponse saveOrUpdate(Long seekerId, ResumeRequest req) {
        ...
        if (req.getTotalExperienceYears() != null)
            resume.setTotalExperienceYears(req.getTotalExperienceYears());
    ...
    public ResumeResponse generateWithAI(Long seekerId) {
        ...
        String html = aiService.generateResumeHtml(seeker, resume);
        resume.setAiGeneratedHtml(html);
        resume.setAiGeneratedText(stripHtml(html));
        return ResumeResponse.from(resumeRepo.save(resume));
    }
